    ...
    <div className="min-h-screen w-full bg-black cursor-none relative">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 pt-32">
        ...
        <motion.div
          ...
          className="w-[114%] -ml-[7%] h-[400px] md:h-[550px] rounded-2xl overflow-hidden pointer-events-auto"
        >
          <Spline
            style={{
              width: '100%',
            ...
            scene="https://prod.spline.design/v3HYBFJWezIbYgf0/scene.splinecode"
          />
        </motion.div>
      </div>
    </div>
